format long e; clearvars; clc; m = 7; nmax = 100; tol = 1e-10;
...
for i = 1:n
    ...
    [X,Y,Vactual,Vapprox,relres,iters] = CG_add_Schwarz(m,nmax,a,b,@(x,y) f(x,y,alpha,beta,gamma),@(x,y) v(x,y,alpha,beta,gamma),tol);
    relress = [relress;relres]; nsolves =[nsolves,iters];
